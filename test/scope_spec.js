...
describe("Scope", function() {
	...
	describe("digest", function() {
		...
		it("executes $evalAsynced function later in the same cycle", function() {
			...
			scope.$watch(
				...
				function(newValue, oldValue, scope) {
					...
					scope.asyncEvalutedImmediately = scope.asyncEvaluated;
				}
			);
		...
		it("schedules a digest $evalAsync", function(done) {
			scope.aValue = "abc";
			scope.counter = 0;
	...
	describe("inheritance", function() {
		...
		it("shadows a parent's property whit the same name", function() {
			var parent = new Scope();
			var child = parent.$new();
	...
	describe("$watchCollection", function() {
		...
		it("notices when a new attribute is added to an object", function() {
			scope.counter = 0;
			scope.obj = {a: 1};
		...
		it("uses the new vallue as the old value on first digest", function() {
			scope.aValue = {a :1, b: 2};
			var oldValueGiven;
